...
public class Galeria {
        ...
        public void mostrarObras() {
                ...
                for (int i = 0; i < this.obras.length; i++) {
                        System.out.printf("%-5d %-22s %-12s $%-10.2f %-8.2f %-8.2f %-8d %s%n",
                                        i+1, this.obras[i].getNombre(), this.obras[i].getAutor(),
        ...
        public void altaObraDeArte() {
                ...
                if (opcion == 1) {
                        ...
                        obra = new Pintura(nombre, autor, precio, altura, peso, piezas, descripcion, tecnica);
                } else {
                        System.out.println("Introduzca el material de la obra.");
                        String material = leer.nextLine();
                        obra = new Escultura(nombre, autor, precio, altura, peso, piezas, descripcion, material);
                }
